package com.music.helpyourdj.ui.main;
...
import com.music.helpyourdj.Music;
import com.music.helpyourdj.Pubs;
import com.music.helpyourdj.R;
import com.ornach.nobobutton.NoboButton;

import java.util.List;

public class RecomendedCustomAdapterPub extends RecyclerView.Adapter<RecomendedCustomAdapterPub.MyRowPubbb> {

    List<Pubs> pubs;
    Context context;

    public RecomendedCustomAdapterPub(List<Pubs> pubs, Context context) {
        this.pubs = pubs;
    ...
    @NonNull
    @Override
    public MyRowPubbb onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view  = LayoutInflater.from(parent.getContext()).inflate(R.layout.rowpub, parent , false);

        RecomendedCustomAdapterPub.MyRowPubbb vh = new RecomendedCustomAdapterPub.MyRowPubbb( view );
        return vh;
    }

    @Override
    public void onBindViewHolder(@NonNull RecomendedCustomAdapterPub.MyRowPubbb holder, int position) {
  ...
  public  class MyRowPubbb extends RecyclerView.ViewHolder {
        ...
        public MyRowPubbb(View pubView){
            super(pubView);
